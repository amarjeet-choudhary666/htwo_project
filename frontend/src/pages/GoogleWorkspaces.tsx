...
import ZimbraFeaturesTable from "@/components/ZimbraFeatures";

export function GoogleWorkspace() {
    return (
        <div>
            <section className="bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900  relative overflow-hidden py-16 px-6 font-poppins">
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-10">
                    ...
                    <div className="lg:w-1/2 text-white space-y-6">
                        ...
                        <p className="text-gray-300 text-base leading-relaxed">
                            Professional email, docs, and collaboration tools
                        </p>

                        <p className="text-gray-300 text-base leading-relaxed">
                            Enhance productivity with Google's suite of business applications
                        </p>
